...
An end-to-end Machine Learning web service and interactive UI for predicting health insurance premium categories, built with **FastAPI**, **Pydantic v2**, **Scikit-Learn**, **Streamlit**, and **Docker**, with model training conducted in **Google Colab** and cloud deployment on **Render**.
...
flowchart TD
    ...
    subgraph Runtime_Inference ["🚀 Production Runtime"]
        User([👤 User / Client]) --> Frontend["🖥️ Streamlit Frontend<br/><i>(frontend.py)</i>"]
        User -->|Direct HTTP Requests| API["⚡ FastAPI Backend<br/><i>(app.py on :8000 / Render Cloud)</i>"]
...
This FastAPI application is ready for continuous deployment on [Render](https://render.com):
- **Build Command**: `pip install -r requirements.txt`
- **Start Command**: `uvicorn app:app --host 0.0.0.0 --port $PORT`
- **Live Endpoint**: `https://fastapi-insurance-premium-prediction.onrender.com`
...
| **Cloud Hosting** | [Render](https://render.com/) | Cloud hosting for the live API |
